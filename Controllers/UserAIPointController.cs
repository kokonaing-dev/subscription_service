...
{
    private readonly IUserAIPointService _service;

    public UserAIPointController(IUserAIPointService service)
    {
        _service = service;
    }
    ...
    // POST
    [HttpPost]
    public async Task<IActionResult> Post([FromBody] UserAIPointCreateDto dto)
    {
        if (dto == null)
        {
