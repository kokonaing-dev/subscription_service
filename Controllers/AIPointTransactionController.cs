...
{
    private readonly IAIPointTransactionService _service;

    public AIPointTransactionController(IAIPointTransactionService service)
    {
        _service = service;
    }
    ...
    // POST
    [HttpPost]
    public async Task<IActionResult> Post([FromBody] AIPointTransactionCreateDto dto)
    {
        if (dto == null)
        {
