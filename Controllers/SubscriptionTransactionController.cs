...
{
    private readonly ISubscriptionTransactionService _service;

    public SubscriptionTransactionController(ISubscriptionTransactionService service)
    {
        _service = service;
    }
    ...
    // POST
    [HttpPost]
    public async Task<IActionResult> Post([FromBody] SubscriptionTransactionCreateDto dto)
    {
        if (dto == null)
        {
